...
#clip national grassland (Nat_250m_grassland)to Surrey project extent
kent<-st_read('spatial_data/original/SussexKent/NRP_SussexKent/NRP_SussexKent.shp')
Nat_grassland<- raster('spatial_data/derived/Nat_250m_grassland.tif')
kent_grassland<-crop(Nat_grassland,kent)
kent_grass_proj<-mask(kent_grassland,kent)
...
filenameNS<-'Loc_Ken_250m_grassland_3k_NS_' #scale_resolution_habitat-type_dispersal-distance_direction
stNS<- raster("spatial_data/derived/st_loc_ken_N_S.tif")
...
filenameEW<-'Loc_Ken_250m_grassland_3k_EW_'
stEW<- raster("spatial_data/derived/st_loc_ken_E_W.tif")
...
filenameNESW<-'Loc_Ken_250m_grassland_3k_NESW_'
stNESW<- raster("spatial_data/derived/st_loc_ken_NE_SW.tif")
...
filenameNWSE<-'Loc_Ken_250m_grassland_3k_NWSE_'
stNWSE<- raster("spatial_data/derived/st_loc_ken_NW_SE.tif")
